...
var dbUrl = 'mongodb://localhost:27017/ipv';
...
app.get('/institucional/mision', function (req, res) {
  res.render('institucional/mision');
});
app.get('/institucional/autoridades', function (req, res) {
  res.render('institucional/autoridades');
});
app.get('/institucional/organigrama', function (req, res) {
  res.render('institucional/organigrama');
});
app.get('/tramites/requisitos', function (req, res) {
  res.render('tramites/requisitos');
});
app.get('/tramites/transferencia', function (req, res) {
