...
var _require = require('./schemas.js'),
  noticiaSchema = _require.noticiaSchema;
...
module.exports.isAuthor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          req.flash('error', 'Usted no esta autorizado para realizar esa accion');
          return _context.abrupt("return", res.redirect("/noticias/".concat(id)));
        case 7:
          next();
        case 8:
        case "end":
...
module.exports.validateNoticia = function (req, res, next) {
  var _noticiaSchema$valida = noticiaSchema.validate(req.body),
    error = _noticiaSchema$valida.error;
  if (error) {
